    ...
    return (
      <SidebarProvider>
        ...
        <SidebarInset className="flex flex-col h-screen overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto relative z-10 [&::-webkit-scrollbar]:hidden scrollbar-none">
            <div className="w-full px-4 md:px-6 py-6">
              <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  {/* Left Column - Warehouses, Suppliers, Distributors Cards */}
                  ...
                  {/* Right Column - Announcements, Todos, and Recent Activity (Sticky) */}

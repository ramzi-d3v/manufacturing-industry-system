            ...
            <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
              <SectionCards />
                    <section className="py-8 w-full">
                      {/* Section Header */}
                      <div className="px-4 lg:px-6 mb-10 max-w-7xl mx-auto">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 relative">
                          <div className="space-y-1">
                            {/* Title with JetBrains Mono and a clean Purple/White Gradient */}
                            <h2 className={cn(
                          ...
                          {/* Custom Separator: Thick to Thin 
                              Uses a height difference and a mask to taper off */}
                          <div 
                      ...
                      {/* Charts Grid */}
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 lg:px-6 max-w-7xl mx-auto items-start">
                        {/* First Chart: User Activity / Desktop Stats */}
                        <div className="space-y-4">
                          <div className="flex items-center gap-2 px-1">
                            <div className="size-2 rounded-full bg-white animate-pulse" />
                            <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">System Traffic</span>
                          </div>
                          <MonochromeBarChart />
                        </div>

                        {/* Second Chart: Expense Analytics */}
                        <div className="space-y-4">
                          <div className="flex items-center gap-2 px-1">
                            <div className="size-2 rounded-full bg-emerald-500" />
                            <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">Cash Outflow</span>
                          </div>
                          <ValueLineBarChart />
                        </div>
                      </div>
